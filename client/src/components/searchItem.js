...
const searchItem = ({ IconBefore, IconAfter, text, fontWeight }) => {
  return (
    <div className="bg-[#fff] w-full  text-[13px] py-2 px-4  rounded-md text-gray-400  cursor-pointer flex items-center justify-between">
      <div className="flex items-center gap-1 w-full">
        {IconBefore}
        <span
          className={`${
            fontWeight && 'font-bold text-black'
